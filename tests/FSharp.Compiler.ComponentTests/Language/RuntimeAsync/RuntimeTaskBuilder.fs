...
type RuntimeTaskBuilder() =
    ...
    member inline _.Bind(computation: Async<'T>, [<InlineIfLambda>] continuation: 'T -> 'U) =
        continuation (AsyncHelpers.Await(Async.StartAsTask computation))
    ...
    member inline _.MergeSources(left: Task<'T1>, right: Async<'T2>) =
        struct (AsyncHelpers.Await left, AsyncHelpers.Await(Async.StartAsTask right))
    member inline _.MergeSources(left: Async<'T1>, right: Task<'T2>) =
        struct (AsyncHelpers.Await(Async.StartAsTask left), AsyncHelpers.Await right)
    member inline _.MergeSources(left: Async<'T1>, right: Async<'T2>) =
        struct (AsyncHelpers.Await(Async.StartAsTask left), AsyncHelpers.Await(Async.StartAsTask right))
    ...
    member inline _.MergeSources(left: Async<'T1>, right: struct ('T2 * 'T3)) =
        struct (AsyncHelpers.Await(Async.StartAsTask left), right)
    ...
    member inline _.MergeSources(left: struct ('T1 * 'T2), right: Async<'T3>) =
        struct (left, AsyncHelpers.Await(Async.StartAsTask right))
